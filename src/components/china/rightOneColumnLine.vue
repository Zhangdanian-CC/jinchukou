    ...
    initColumnChart(id, data, currentPro) {
      ...
      myCharts.setOption({
        ...
        legend: {
          ...
          data: [
            {
              name: data.y ? data.y[0].name : "营业收入"
              //icon:'image://../wwwroot/js/url2.png', //路径
            },
            {
              name: data.y ? data.y[0].name : "营业支出"
              //icon:'image://../wwwroot/js/url2.png', //路径
            },
            {
              name: data.y ? data.y[1].name : "利润总额"
            }
          ],
          textStyle: {
            color: "#a8aab0",
        ...
        series: [
          {
            ...
            data: data.y
              ? data.y[0].data
              : [10, 15, 30, 45, 55, 60, 62, 80, 80, 62, 60, 78],
            barWidth: e/1600*4,
            barGap: 0, //柱间距离
            itemStyle: {
              normal: {
          ...
          {
            name: data.y ? data.y[1].name : "营业支出",
            type: "bar",
            data: data.y
              ? data.y[1].data
          ...
          {
            name: data.y ? data.y[2].name : "利润总额",
            type: "line",
            data: data.y
              ? data.y[1].data
              : [8, 5, 25, 30, 35, 55, 62, 78, 65, 55, 60, 92],
